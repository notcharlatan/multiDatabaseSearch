...
def init_dynamic_dbs():
    ...
    for db in default_dbs:
        ...
        # 新增table_comment字段
        db["table_meta"] = {}       # {table_name: {"columns": [], "columns_comment": [], "preview_data": [], "table_comment": "", "enable_search": True}}
    return default_dbs
...
def add_db_to_list(st_session, db_info):
    ...
    db_info["db_id"] = db_id
    db_info["enable_search"] = True
    db_info["table_meta"] = {}  # 初始化表元信息（含注释）
